...
This document provides context and instructions for Claude Code working on the TeslaCamPlayer codebase.
...
## Conventions
- **Read this file before coding**: Always review `CLAUDE.md` at the start of each task.
...
## Development Branch
- Always develop on a `claude/` prefixed branch matching the session ID.
