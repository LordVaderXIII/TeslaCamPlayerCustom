    ...
    public static class VersionInfo
    {
        ...
        public static readonly List<VersionRelease> Releases = new List<VersionRelease>
        {
            new VersionRelease
            {
                ...
                {
                    "perf: Optimize date picker navigation by replacing O(N) LINQ scans with O(1) array checks"
                }
            },
            new VersionRelease
            {
                ...
                Changes = new List<string>
                {
                    "security: Add Content-Security-Policy (CSP) headers to improve security against XSS"
                }
            },
            new VersionRelease
            {
                Version = "2025-12-1.3.10",
                Date = "2025-01-28",
                Changes = new List<string>
                {
                    "perf: Optimize event filtering to reduce memory allocations and improve UI responsiveness"
                }
            },
            new VersionRelease
            {
                Version = "2025-12-1.3.9",
                Date = "2025-12-21",
                Changes = new List<string>
                {
                    "fix: Enable real telemetry extraction by implementing missing interop logic in telemetry-interop.js",
                    "fix: Correctly map Protobuf gear/autopilot states to C# models"
                }
            },
            new VersionRelease
            {
            ...
            new VersionRelease
            {
                ...
                Changes = new List<string>
                {
                    "perf: Enable response compression for API and static files"
                }
            },
            new VersionRelease
            {
